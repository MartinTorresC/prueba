...
class principal(QtGui.QMainWindow, form_class):
    ...
    def Inicializar (self):
        ...
        self.tblResultado.setItem(0,0, QTableWidgetItem(""))
        ...
        self.tblResultado.setItem(1,0, QtGui.QTableWidgetItem("")) 
        ...
        self.tblResultado.setItem(2,0, QtGui.QTableWidgetItem("")) 
        ...
        self.tblResultado.setItem(3,0, QtGui.QTableWidgetItem("")) 
        ...
        self.tblResultado.setItem(4,0, QtGui.QTableWidgetItem(""))
